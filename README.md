...
[![go report card](https://goreportcard.com/badge/free-life/third_party/uadmin "go report card")](https://goreportcard.com/report/free-life/third_party/uadmin)
[![GoDoc](https://godoc.org/free-life/third_party/uadmin?status.svg)](https://godoc.org/free-life/third_party/uadmin)
...
[![License: MIT](https://img.shields.io/badge/License-MIT-brightgreen.svg)](https://free-life/third_party/uadmin/blob/master/LICENSE)
...
![Dashboard](https://free-life/third_party/uadmin-docs/raw/master/assets/uadmindashboard.png)
&nbsp;

### Log

![Log](https://free-life/third_party/uadmin-docs/raw/master/assets/log.png)
&nbsp;

### Login Form

![Login Form](https://free-life/third_party/uadmin-docs/raw/master/tutorial/assets/loginform.png)
&nbsp;
...
```bash
$ go get -u free-life/third_party/uadmin/...
```
...
[  INFO  ]   Copying static/templates from: /Users/abdullah/go/pkg/mod/free-life/third_party/uadmin@v0.6.0
...
$ go mod tidy
go: finding module for package free-life/third_party/uadmin
go: found free-life/third_party/uadmin in free-life/third_party/uadmin v0.6.0
```
