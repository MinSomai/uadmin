...
//	}
	...
	//
	//if err != nil {
	//	utils.Trail(utils.ERROR, "generateTranslation error creating folder (./static/i18n/"+pkgName+"/). %v", err)
	//	return stat
	//}
	//
	...
	//	if err != nil {
	//		utils.Trail(utils.ERROR, "generateTranslation error writing a file. %v", err)
	//	}
	...
	//		err = ioutil.WriteFile(fileName, buf, 0644)
	//		if err != nil {
	//			utils.Trail(utils.ERROR, "Unable to write language file (%s)", fileName)
	//			return stat
	//		}
	//	}
	//
	...
	//		if err != nil {
	//			utils.Trail(utils.ERROR, "Unable to write language file language file (%s)", langFileName)
	//		}
	//	}
	//}
//	return stat
