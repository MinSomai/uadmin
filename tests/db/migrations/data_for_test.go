...
func (m initial1621667392) Up(uadminDatabase *core.UadminDatabase) error {
	appliedMigrations = append(appliedMigrations, m.GetName())
	return nil
}

func (m initial1621667392) Down(uadminDatabase *core.UadminDatabase) error {
...
func (m migration21621667393) Up(uadminDatabase *core.UadminDatabase) error {
	appliedMigrations = append(appliedMigrations, m.GetName())
	return nil
}

func (m migration21621667393) Down(uadminDatabase *core.UadminDatabase) error {
	appliedMigrations = core.Remove(appliedMigrations, m.GetName())
	return nil
}
...
func (m initialtest11621667392) Down(uadminDatabase *core.UadminDatabase) error {
	appliedMigrations = core.Remove(appliedMigrations, m.GetName())
	return nil
}
...
func (m migration2test1621667393) Down(uadminDatabase *core.UadminDatabase) error {
	appliedMigrations = core.Remove(appliedMigrations, m.GetName())
	return nil
}
...
func (m initialblueprintconflicts1621667392) Down(uadminDatabase *core.UadminDatabase) error {
	return nil
}
...
func (m migration2blueprintconflicts1621667392) Down(uadminDatabase *core.UadminDatabase) error {
	return nil
}
...
func (m migration3blueprintconflicts1621667392) Down(uadminDatabase *core.UadminDatabase) error {
	return nil
}
...
func (m migration4blueprintconflicts1621667392) Down(uadminDatabase *core.UadminDatabase) error {
	return nil
}
...
func (m nodeps11621667392) Down(uadminDatabase *core.UadminDatabase) error {
	return nil
}
...
func (m nodeps21621667392) Down(uadminDatabase *core.UadminDatabase) error {
	return nil
}
...
func (m loopedmigration11621667392) Down(uadminDatabase *core.UadminDatabase) error {
	return nil
}
...
func (m loopedmigration21621667392) Down(uadminDatabase *core.UadminDatabase) error {
	return nil
}
...
func (m samenamemigration11621667392) Down(uadminDatabase *core.UadminDatabase) error {
	return nil
}
...
func (m samenamemigration21621667392) Down(uadminDatabase *core.UadminDatabase) error {
	return nil
}
